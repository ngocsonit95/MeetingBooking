...
*/
(function (l) {
  "object" === typeof module && module.exports ? (l["default"] = l,
    module.exports = l) : "function" === typeof define && define.amd ? define(function () {
      return l
  ...
  (function (e) {
    ...
    n.prototype.addSingleSeriesAsDrilldown = function (a, b) {
      var c = a.series, d = c.xAxis, f = c.yAxis, h, g = [], m = [], k, q, l;
      l = this.styledMode ? {
      ...
      c.chart.series.forEach(function (a) {
        a.xAxis !== d || a.isDrilling || (a.options._ddSeriesId = a.options._ddSeriesId || C++ ,
          a.options._colorIndex = a.userOptions._colorIndex,
          a.options._levelNumber = a.options._levelNumber || k,
          q ? (g = q.levelSeries,
            m = q.levelSeriesOptions) : (g.push(a),
              m.push(a.options)))
      });
      a = r({
        levelNumber: k,
      ...
      d && (d.oldPos = d.pos,
        d.userMin = d.userMax = null,
        f.userMin = f.userMax = null);
      c.type === b.type && (b.animate = b.animateDrilldown || w,
        b.options.animation = !0)
    }
      ;
    n.prototype.applyDrilldown = function () {
      var a = this.drilldownLevels, b;
      a && 0 < a.length && (b = a[a.length - 1].levelNumber,
    ...
    n.prototype.getDrilldownBackText = function () {
      ...
      if (a && 0 < a.length)
        return a = a[a.length - 1],
          ...
          D(this.options.lang.drillUpText, a)
    }
      ;
    n.prototype.showDrillUpButton = function () {
      var a = this, b = this.getDrilldownBackText(), c = a.options.drilldown.drillUpButton, d, f;
      this.drillUpButton ? this.drillUpButton.attr({
        text: b
      }).align() : (f = (d = c.theme) && d.states,
      ...
      if (this.drilldownLevels && 0 !== this.drilldownLevels.length) {
        for (var a = this, b = a.drilldownLevels, c = b[b.length - 1].levelNumber, d = b.length, f = a.series, h, g, e, k, q = function (b) {
          ...
          if (g = b[d],
            ...
            k.type === e.type && (k.drilldownLevel = g,
              k.options.animation = a.options.drilldown.animation,
              e.animateDrillupFrom && e.chart && e.animateDrillupFrom(g));
            k.options._levelNumber = c;
            e.remove(!1);
            k.xAxis && (h = g.oldExtremes,
              k.xAxis.setExtremes(h.xMin, h.xMax, !1),
              k.yAxis.setExtremes(h.yMin, h.yMax, !1));
            g.resetZoomButton && (a.resetZoomButton = g.resetZoomButton,
              a.resetZoomButton.show())
          }
        u(a, "drillupall");
        this.redraw();
    ...
    e.addEvent(n, "render", function () {
      (this.xAxis || []).forEach(function (a) {
        ...
        a.series.forEach(function (b) {
          var c, d = b.xData || [], f = b.points, h;
          for (c = 0; c < d.length; c++)
            h = b.options.data[c],
              "number" !== typeof h && (h = b.pointClass.prototype.optionsToObject.call({
                series: b
              }, h),
                h.drilldown && (a.ddPoints[d[c]] || (a.ddPoints[d[c]] = []),
    ...
    p.prototype.animateDrillupTo = function (a) {
      if (!a) {
        ...
        this.points.forEach(function (a) {
          ...
          b && (b.hidden = "hidden" === b.attr("visibility"),
            b.hidden || (b.hide(),
        ...
        e.syncTimeout(function () {
          b.points && b.points.forEach(function (a, b) {
            ...
            if (a.graphic)
              a.graphic[b](d);
            f && !f.hidden && (f.fadeIn(),
              a.connector && a.connector.fadeIn())
          })
    ...
    p.prototype.animateDrilldown = function (a) {
      var b = this, c = this.chart, d = c.drilldownLevels, f, e = l(c.options.drilldown.animation), g = this.xAxis, m = c.styledMode;
      a || (d.forEach(function (a) {
        b.options._ddSeriesId === a.lowerSeriesOptions._ddSeriesId && (f = a.shapeArgs,
          m || (f.fill = a.color))
      }),
        f.x += t(g.oldPos, g.pos) - g.pos,
        this.points.forEach(function (a) {
          var c = a.shapeArgs;
          m || (c.fill = a.color);
    ...
    p.prototype.animateDrillupFrom = function (a) {
      ...
      this.points.forEach(function (h) {
        ...
        g && (delete h.graphic,
          f.chart.styledMode || (m.fill = a.color),
          b.duration ? g.animate(m, e.merge(b, {
            complete: k
          })) : (g.attr(m),
            k()))
      })
    ...
    e.Point.prototype.doDrilldown = function (a, b, c) {
      var d = this.series.chart, f = d.options.drilldown, e = (f.series || []).length, g;
      d.ddDupes || (d.ddDupes = []);
      for (; e-- && !g;)
        f.series[e].id === this.drilldown && -1 === d.ddDupes.indexOf(this.drilldown) && (g = f.series[e],
    ...
    B.prototype.drillable = function () {
      ...
      d && (b && f && f.length ? (b.drillable = !0,
        b.basicStyles || h || (b.basicStyles = e.merge(b.styles)),
        b.addClass("highcharts-drilldown-axis-label").on("click", function (b) {
          c.drilldownCategory(a, b)
        }),
        h || b.css(c.chart.options.drilldown.activeAxisLabelStyle)) : b && b.drillable && (h || (b.styles = {},
          b.css(b.basicStyles)),
          b.on("click", null),
          b.removeClass("highcharts-drilldown-axis-label")))
    }
      ;
    e.addEvent(e.Point, "afterInit", function () {
      var a = this
        , b = a.series;
    ...
    e.addEvent(e.Series, "afterDrawDataLabels", function () {
      ...
      this.points.forEach(function (d) {
        ...
        d.drilldown && d.dataLabel && ("contrast" !== a.color || c || (e.color = b.getContrast(d.color || this.color)),
...
(function (l) {
  ...
  (function (e) {
    var l = e.animObject
      ...
      , C = 1;
    r(y.lang, {
      drillUpText: "\u25c1 Quay lại {series.name}"
    });
    y.drilldown = {
      activeAxisLabelStyle: {
        cursor: "pointer",
