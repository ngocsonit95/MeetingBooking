<template>
  <div id="calendar-booking" class="modal fade bd-example-modal-lg" role="dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="text-center">
            <button class="btn btn-success mr-2" @click="BookCalendar()">
...
<script>
  ...
  export default {
    ...
    mounted() {
      let seft = this;
      $("#calendar-booking").on('shown.bs.modal', function (e) {
    ...
    created() {
      ...
      let currentDate = new Date();
      seft.hours = currentDate.getHours();
      seft.minute = currentDate.getMinutes();

      EventBus.$on("calendarBooking", item => {
      seft.seat = item.Seat;
        var splitTime =item.dateStr.split("-");
        seft.timeStart = splitTime[2] + "/" + splitTime[1] + "/" + splitTime[0] + "/" + " " + seft.hours + ":" + seft.minute;

        seft.timeEnd = splitTime[2]+"/" + splitTime[1]+"/" +splitTime[0]+"/" + " " + seft.hours + ":" + seft.minute;
        $("#calendar-booking").modal("show");
      });
    }
  }
